...
public enum ErrorResponseCode implements BaseResponseCode {
    ...
    RECOMMENDATION_REFRESH_CONFLICT("RECOMMENDATION_REFRESH_CONFLICT", STATE_CONFLICT, "현재 상태에서는 추천을 새로고침할 수 없습니다."),
    RECOMMENDATION_REFRESH_EXHAUSTED("RECOMMENDATION_REFRESH_EXHAUSTED", STATE_CONFLICT, "이전 추천과 겹치지 않는 새 원재료가 부족합니다."),
