...
public class RecommendationController {
    ...
    @GetMapping("/recommendations/{recommendationId}/decision")
    public ResponseEntity<RecommendationDecisionRes> getDecision(
            @RequestHeader("Authorization") String authorization,
            @PathVariable String recommendationId
    ) {
        return ResponseEntity.ok(recommendationService.getDecision(
                authorization,
                recommendationId
        ));
    }
